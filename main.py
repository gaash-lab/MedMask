...
def get_args_parser(parser):
    ...
    parser.add_argument('--train_annotations_path', default='/home/suhaib/Research/Drive/Datasets/BCD_RSNA/coco/annotations/instances_train2017.json', type=str)
    ...
    parser.add_argument('--conf-threshold', default=0.1, type=float, help='Confidence threshold for evaluation')
    # mode settings
