...
class DeformableDETR(nn.Module):
    ...
    def forward(self, images, masks, enable_mae=False, mask_ratio=0.8):
        # Backbone forward
        # create embidings of features (multiscale) and move the npy embidings to engine or main file 
        ...
        # ------------
        embeddings = hs[-1]
        embeddings = embeddings / (embeddings.norm(dim=-1, keepdim=True) + 1e-7)
