...
class CocoStyleDataset(CocoDetection):
    ...
    img_dirs = {
        ...
        'inbreast': {
            'train': 'coco_uniform_ts/train2017', 'val': 'coco_uniform_ts/val2017', 'test': 'coco_uniform_ts/test2017',
        },
        'inbreast_cr': {
        ...
        'dentex': {
            'train': 'coco/train2017', 'val': 'coco/val2017', 'test': 'coco/test2017',
        },
        'rsna': {
            'train': 'coco_uniform_ts/train2017', 'val': 'coco_uniform_ts/val2017', 'test': 'coco_uniform_ts/test2017',
        },
    ...
    anno_files = {
        ...
        'inbreast': {
            'source': {
                'train': 'coco_uniform_ts/annotations/instances_train2017.json',
                'val': 'coco_uniform_ts/annotations/instances_val2017.json',
            },
            'target': {
                'train': 'coco_uniform_ts/annotations/instances_train2017.json',
                'val': 'coco_uniform_ts/annotations/instances_val2017.json',
                'test': 'coco_uniform_ts/annotations/image_info_test-dev2017.json',
            },
        },
        'inbreast_cr': {
            'source': {
        ...
        'dentex': {
            'source': {
                'train': 'coco/annotations/instances_train2017.json',
                'val': 'coco/annotations/instances_val2017.json',
            },
            'target': {
                'train': 'coco/annotations/instances_train2017.json',
                'val': 'coco/annotations/instances_val2017.json',
                'test': 'coco/annotations/image_info_test-dev2017.json',
            },
        },
        'rsna': {
            'source': {
