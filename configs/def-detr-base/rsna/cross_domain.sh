...
--source_dataset rsna \
--target_dataset rsna \
--mae_source_dataset rsna \
--mae_target_dataset rsna \
--embeddings_dir /home/suhaib/Research/Drive/Outputs/embeddings/train_rsna \
--train_annotations_path /home/suhaib/Research/Drive/Datasets/BCD_RSNA/coco_uniform_ts/annotations/instances_train2017.json \
